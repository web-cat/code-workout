  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved course as @course" do
        ...
        post :create, params: {:course => { "name" => "invalid value" }}, session: valid_session
        assigns(:course).should be_a_new(Course)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested course" do
        ...
        put :update, params: {:id => course.to_param, :course => { "name" => "MyString" }}, session: valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the course as @course" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Course.any_instance.stub(:save).and_return(false)
        put :update, params: {:id => course.to_param, :course => { "name" => "invalid value" }}, session: valid_session
        assigns(:course).should eq(course)
      end
