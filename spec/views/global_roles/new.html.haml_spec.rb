...
describe "global_roles/new" do
  before(:each) do
    assign(:global_role, stub_model(GlobalRole,
      :name => "MyString",
  ...
  it "renders new global_role form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", global_roles_path, "post" do
